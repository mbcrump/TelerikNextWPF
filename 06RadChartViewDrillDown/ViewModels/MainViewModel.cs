...
using _06RadChartViewDrillDown.DataProviders;
using _06RadChartViewDrillDown.Models;

namespace _06RadChartViewDrillDown.ViewModels
{
    public class MainViewModel : ViewModelBase
    {
        ...
        internal void HandleItemClicked(object item)
        {
            ...
            if (company != null)
            {
                driller = new DrillDownHelper(company.Products, "ProductName", "CurrentPrice", "BarSeries",
                    company.CompanyName);
            }
