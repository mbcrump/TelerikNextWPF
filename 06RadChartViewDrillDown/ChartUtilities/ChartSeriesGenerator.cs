...
namespace _06RadChartViewDrillDown.ChartUtilities
{
    public static class ChartSeriesGenerator
    {
        ...
        private static void OnDrillDownHelperChanged(DependencyObject target, DependencyPropertyChangedEventArgs args)
        {
            ...
            CategoricalSeries series = CreateSeries(driller.CatBinding, driller.ValBinding, driller.Data,
                driller.SeriesType);
            chart.Series.Add(series);
        }

        private static CategoricalSeries CreateSeries(string catBinding, string valBinding,
            System.Collections.IEnumerable data, string seriesType)
        {
